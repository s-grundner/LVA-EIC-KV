...
The \acs{MIDI} decoder is responsible for extracting \acs{MIDI} command aswell as channel and number from the received bytes. The in and outputs of this module can be seen in \autoref{lst:midi-module}.
