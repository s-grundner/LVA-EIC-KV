...
\begin{figure}[h]
    ...
    \caption{Input and output visualisation and description}\label{} 
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Layout of the Tile}
\end{figure}

\input{tables/gds.tex}

\section{Reciever and MIDI-Decoder}
...
\begin{table}[h]
\caption{List of used software for development and comissioning this project}
